...
/// <summary>
/// Represents a localized wrapped text component.
/// </summary>
internal class LocalizedWrappedText : WrappedText, ILocalizable
{
    private LocalizedString localizedString = LocalizedString.Default;

    /// <summary>
    /// Initializes a new instance of the <see cref="LocalizedWrappedText"/> class.
    /// </summary>
    /// <param name="font">The font of the text.</param>
    /// <param name="color">The color of the displayed text.</param>
    public LocalizedWrappedText(ScalableFont font, Color color)
        : base(font, color)
    {
